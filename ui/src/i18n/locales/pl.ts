...
export const pl: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Nie wyczyszczono żadnej zapisanej sesji WhatsApp. Być może już jej nie ma albo jej katalog uwierzytelniania może wymagać ręcznego wyczyszczenia.",
    },
  ...
  sessionsView: {
    ...
    invalidEmojiIcon: "Wpisz dokładnie jeden emoji.",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileHint:
        "JPEG, PNG lub WebP. Obrazy są kadrowane do środka i zmieniane do rozmiaru 512 px.",
  ...
  configView: {
    categories: {
      ...
      security: "Prywatność i zabezpieczenia",
      automation: "Automatyzacja",
  ...
  custodian: {
    ...
    connectionChanged:
      "Połączenie Gateway uległo zmianie. Spróbuj ponownie, aby kontynuować tę konfigurację.",
    sessionRestarted:
    ...
    nudge: {
      ...
      channelAuth: "Uwierzytelnianie {channel} działa gorzej — zapytaj mnie, co się stało",
  ...
  mcpServers: {
    ...
    nameInvalid: "Nazwy serwerów mogą zawierać litery, cyfry, kropki, łączniki lub podkreślenia.",
    targetInvalid: "Wpisz URL dla transportów HTTP lub prawidłowy wiersz polecenia dla stdio.",
  ...
  mcpPage: {
    connectorsLink: "Odkryj konektory jednym kliknięciem na stronie Wtyczki.",
    servers: "Serwery",
    oauth: "OAuth",
    filtered: "Filtrowane",
  ...
  labsPage: {
    intro:
      "Labs zawiera eksperymentalne funkcje, które mogą się zmieniać, psuć lub znikać między wydaniami.",
    ...
    swarm: {
      title: "Swarm",
      description: "Pozwól Code Mode równolegle koordynować grupy subagentów.",
      empty: "Brak aktywnych swarmów.",
  ...
  appsPage: {
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Łatwe do szybkiego sprawdzenia czaty i szybkie odpowiedzi z nadgarstka.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      chrome: {
        ...
        desc: "Pozwól OpenClaw sterować Twoją obecną przeglądarką Chrome — kartami, stronami i formularzami.",
      },
      plugins: {
  ...
  profilePage: {
    ...
    identity: {
      title: "Tożsamość",
      description: "Twój profil w tym Gateway.",
      ...
      displayName: "Nazwa wyświetlana",
      displayNameDescription: "Wyświetlana innym osobom korzystającym z tego Gateway.",
      ...
      avatarErrors: {
        ...
        tooLarge: "Przetworzony awatar ma więcej niż 512 KB.",
      },
    },
  },
  tasksPage: {
  ...
  gatewayLogs: {
    ...
    autoFollow: "Automatyczne śledzenie",
    file: "Plik: {file}",
    truncated: "Dane wyjściowe logu zostały skrócone; wyświetlany jest najnowszy fragment.",
  ...
  board: {
    ...
    emptyTitle: "Przejrzysta tablica, gotowa do pracy",
    emptyHint: "Twój agent może przypinać tutaj widżety — spróbuj poprosić o kartę statusu.",
    actionFailed: "Nie udało się zapisać zmiany w panelu.",
    actionInProgress: "Inna zmiana w panelu jest nadal zapisywana.",
    announcement: {
      moved: "Przeniesiono {title}.",
      resized: "Zmieniono rozmiar {title}.",
      removed: "Usunięto {title}.",
      granted: "Dostęp do widżetu został dozwolony.",
      rejected: "Dostęp do widżetu został odrzucony.",
    },
    widget: {
      cellLabel:
      ...
      appStaleDetail: "Jego serwer, zasób lub transkrypcja źródłowa nie są już dostępne.",
      retry: "Ponów",
      ...
      sandboxOriginRequired:
        "Autoryzacja widżetu nie powiodła się po wielokrotnych próbach odświeżenia. Jeśli Gateway działa za reverse proxy lub tunelem, który nie przekierowuje portu piaskownicy widżetu, ustaw mcp.apps.sandboxOrigin na dedykowane publiczne źródło kierowane do nasłuchiwacza piaskownicy.",
  ...
  workboard: {
    ...
    dashboardEmpty: "Nie ma jeszcze panelu — agent roboczy może przypinać widżety.",
    openSession: "Otwórz sesję",
  ...
  chat: {
    ...
    board: {
      ...
      dockLeft: "Przypnij czat po lewej",
      dockRight: "Przypnij czat po prawej",
      dockBottom: "Przypnij czat na dole",
      ...
      defaultTab: "Główne",
      mockPlaceholder: "Łączenie widoku tablicy · {tabs} kart · {widgets} widżetów",
    ...
    workspaceConflict: {
      ...
      description:
        "OpenClaw zachował Twoje wersje lokalne i zastosował pozostałe zmiany z chmury. Sprawdź przygotowany wynik lub użyj jego wersji dla ścieżki z konfliktem.",
      morePaths: "+{count} więcej ścieżek",
      stagedResult: "Przygotowany wynik z chmury",
      copyStagedResult: "Kopiuj ref przygotowanego wyniku",
      inspectCloud: "Sprawdź pierwszą wersję z chmury",
      takeCloud: "Użyj pierwszej wersji z chmury",
      copyInspectCommand: "Kopiuj polecenie sprawdzenia chmury",
      copyTakeCommand: "Kopiuj polecenie take-cloud",
      commandHelp:
        "Uruchom je w Bash lub zsh (Git Bash w systemie Windows). Jeśli inspect informuje, że ścieżka nie istnieje, chmura ją usunęła; zweryfikuj to i usuń lokalną ścieżkę ręcznie. Jeśli checkout zgłasza konflikt pliku/katalogu, przenieś lub usuń blokującą ścieżkę lokalną, a następnie spróbuj ponownie. Jeśli brakuje przygotowanego ref, powiadomienie jest nieaktualne; nie zmieniaj ścieżki lokalnej.",
      commandsUnavailable:
        "Ta nazwa pliku zawiera znaki sterujące terminala, więc OpenClaw nie utworzy dla niej możliwego do skopiowania polecenia powłoki. Sprawdź przygotowany ref bezpośrednio i ostrożnie wprowadź ścieżkę ręcznie.",
      ...
      eventDescription:
        "Dla tych ścieżek zachowano wersje lokalne; zastosowano inne zmiany z chmury.",
    },
    compaction: {
    ...
    messages: {
      ...
      forkFromHere: "Utwórz odgałęzienie od tego miejsca",
      hide: "Ukryj",
    ...
    modelControls: {
      ...
      usingDefault: "Używany jest domyślny model z Ustawień",
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Przytrzymaj przycisk mikrofonu w kompozytorze, mów, a następnie zwolnij, aby wstawić tekst bez wysyłania.",
      ...
      dictationFinalizationTimedOut:
        "Dyktowanie zostało zatrzymane, zanim ostatnia częściowa transkrypcja mogła zostać sfinalizowana.",
      dictationProviderUnavailable:
        "Nie skonfigurowano żadnego dostawcy transkrypcji do dyktowania.",
      ...
      selectedCameraUnavailable:
        "Wybrana kamera jest niedostępna. Wybierz inną kamerę lub domyślne ustawienie systemowe.",
  ...
  cron: {
    ...
    form: {
      ...
      script: "Skrypt",
      readOnlyPayloadHelp:
        "Ten ładunek został utworzony poza Control UI. Jego zawartość pozostaje tylko do odczytu i zostanie zachowana podczas zapisywania innych zmian.",
