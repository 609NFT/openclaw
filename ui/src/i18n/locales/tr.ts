...
export const tr: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Kayıtlı WhatsApp oturumu temizlenmedi. Zaten mevcut olmayabilir veya kimlik doğrulama dizininin elle temizlenmesi gerekebilir.",
    },
  ...
  sessionsView: {
    ...
    deleteAllArchivedConfirm:
      "{count} arşivlenmiş ileti dizisini ve dökümlerini silmek istiyor musunuz?",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      uploading: "İşleniyor…",
      profileHint:
        "JPEG, PNG veya WebP. Görseller ortadan kırpılır ve 512px boyutuna yeniden boyutlandırılır.",
  ...
  configView: {
    ...
    syncedHint: "Gateway üzerinden cihazlarınız arasında eşitlenir.",
    notifications: {
      ...
      nativeBlockedHint:
        "macOS’te OpenClaw için bildirimler devre dışı. Sistem Ayarları > Bildirimler bölümünden izin verin.",
    },
    appearance: {
      theme: "Tema",
  ...
  subtitles: {
    ...
    labs: "Deneysel ajan ve araç özellikleri.",
  ...
  custodian: {
    ...
    history: {
      ...
      description: "Bu sistemde değişenler, en yeniden eskiye.",
    ...
    nudge: {
      ...
      channelDisconnected: "{channel} az önce bağlantıyı kesti — bana ne olduğunu sor",
  ...
  mcpServers: {
    ...
    transportStreamableHttp: "Akış yapılabilir HTTP",
    transportSse: "SSE",
    transportStdio: "Stdio",
    targetLabel: "URL veya komut",
    nameInvalid:
      "Sunucu adlarında harfler, sayılar, noktalar, kısa çizgiler veya alt çizgiler kullanılır.",
    targetInvalid: "HTTP taşıyıcıları için bir URL veya stdio için geçerli bir komut satırı girin.",
  ...
  mcpPage: {
    connectorsLink: "Plugins sayfasında tek tıklamayla kullanılan bağlayıcıları keşfedin.",
    servers: "Sunucular",
    oauth: "OAuth",
  ...
  labsPage: {
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "Aracıların araçları kompakt, korumalı alanlı JavaScript iş akışlarında birleştirmesine izin verin.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "iOS'ten OpenClaw içinde sohbet edin, konuşun, eylemleri onaylayın ve paylaşın.",
      },
      android: {
        title: "Android",
  ...
  profilePage: {
    ...
    identity: {
      ...
      avatar: "Avatar",
      avatarDescription:
        "PNG, JPEG veya WebP. Görseller 256 × 256 ya da daha küçük olacak şekilde yeniden boyutlandırılır.",
  ...
  board: {
    ...
    emptyHint: "Aracınız bileşenleri buraya sabitleyebilir — bir durum kartı istemeyi deneyin.",
    ...
    widget: {
      ...
      sandboxOriginRequired:
        "Tekrarlanan yenileme denemelerinden sonra widget yetkilendirmesi başarısız oldu. Gateway, widget sandbox bağlantı noktasını yönlendirmeyen bir ters proxy veya tünelin arkasında çalışıyorsa, mcp.apps.sandboxOrigin değerini sandbox dinleyicisine yönlendirilen özel bir genel origin olarak ayarlayın.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      copied: "Kopyalandı",
      branches: "İleti dizisi dalları",
      branchSwitchUnavailable: "Temsilci çalışırken dal değiştirme kullanılamaz.",
      branchSwitchRequiresAdmin: "Dal değiştirme için operatör yönetici erişimi gerekir.",
      untitledBranch: "Adsız dal",
      oneMessage: "{count} ileti",
      messages: "{count} ileti",
      activeBranch: "Etkin dal",
    },
    board: {
      faceLabel: "İleti dizisi yüzü",
      chatFace: "Sohbet",
      dashboardFace: "Pano",
      ...
      defaultTab: "Ana",
      mockPlaceholder: "Pano görünümü birleşim yeri · {tabs} sekme · {widgets} widget",
    ...
    workspaceConflict: {
      ...
      copyStagedResult: "Hazırlanan sonuç ref değerini kopyala",
      ...
      commandHelp:
        "Bunları Bash veya zsh içinde çalıştırın (Windows’ta Git Bash). Inspect yolun mevcut olmadığını söylüyorsa bulut onu silmiştir; doğrulayın ve yerel yolu manuel olarak kaldırın. Checkout bir dosya/dizin çakışması bildirirse engelleyici yerel yolu taşıyın veya kaldırın, ardından tekrar deneyin. Staged ref eksikse bildirim güncel değildir; yerel yolu değiştirmeyin.",
      commandsUnavailable:
        "Bu dosya adı terminal denetim karakterleri içerdiğinden OpenClaw bunun için kopyalanabilir bir shell komutu oluşturmayacak. Staged ref’i doğrudan inceleyin ve yolu dikkatli bir şekilde manuel olarak girin.",
      dismiss: "Çalışma alanı çakışma bildirimini kapat",
    ...
    messages: {
      ...
      hide: "Gizle",
      hideConfirm: "Bu mesaj bu tarayıcıda gizlensin mi? Aracı hâlâ bunu görür.",
    ...
    modelControls: {
      ...
      reasoning: "Akıl yürütme",
      speed: "Hız",
      sessionOverride: "İleti dizisi geçersiz kılması",
    ...
    composer: {
      ...
      dictationFinalizationTimedOut: "Son kısmi döküm kesinleştirilemeden dikte durduruldu.",
    ...
    sessionDiscussion: {
      ...
      unavailable: "Bu tartışma yerleştirilemez.",
    },
    workspaceFiles: {
