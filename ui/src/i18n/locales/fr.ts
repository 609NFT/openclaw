...
export const fr: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Aucune session WhatsApp stockée n’a été effacée. Elle est peut-être déjà absente, ou son répertoire d’authentification peut nécessiter un nettoyage manuel.",
    },
  ...
  nodes: {
    pairing: {
      ...
      noApp: "Vous n’avez pas encore l’app ?",
      getApps: "Obtenir les apps",
  ...
  sessionsView: {
    ...
    deleteAllArchived: "Supprimer tous les éléments archivés…",
    ...
    attentionRequired: "La session requiert votre attention",
    model: "Modèle",
    ...
    cloudWorkerDescendantConflict: "Enfant de cloud worker : 1 conflit d’espace de travail",
    cloudWorkerDescendantConflicts:
      "Enfants de cloud worker : {count} conflits d’espace de travail",
  ...
  configView: {
    ...
    syncedHint: "Synchronisé sur vos appareils via la gateway.",
    notifications: {
  ...
  mcpServers: {
    ...
    transportStreamableHttp: "HTTP diffusable",
    transportSse: "SSE",
  ...
  labsPage: {
    ...
    sectionDescription:
      "Les modifications sont enregistrées immédiatement et s’appliquent aux futures exécutions d’agent.",
    ...
    codeMode: {
      title: "Mode Code",
      description:
        "Permettre aux agents de combiner des outils dans des workflows JavaScript compacts et isolés.",
    },
    swarm: {
      title: "Essaim",
      description: "Permettre au Mode Code d’orchestrer des groupes de sous-agents en parallèle.",
  ...
  appsPage: {
    ...
    heroTagline:
      "Des apps compagnons pour votre téléphone, votre montre, votre ordinateur et votre navigateur — ainsi que des plugins pour étendre les capacités de votre agent.",
    sectionMobile: "Sur votre téléphone",
    havePhone: "Vous avez déjà l’app ?",
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Des chats consultables en un coup d’œil et des réponses rapides depuis votre poignet.",
      },
      wearOs: {
        title: "Wear OS",
  ...
  profilePage: {
    ...
    identity: {
      title: "Identité",
      description: "Votre profil sur cette gateway.",
      ...
      displayName: "Nom d’affichage",
      displayNameDescription: "Affiché aux autres personnes utilisant cette gateway.",
  ...
  gatewayLogs: {
    title: "Journaux",
    subtitle: "Journaux de fichiers Gateway (JSONL).",
    ...
    autoFollow: "Suivi automatique",
    file: "Fichier : {file}",
    truncated: "Sortie du journal tronquée ; affichage du dernier fragment.",
  ...
  board: {
    ...
    moreTabs: "Autres onglets du tableau de bord",
    ...
    widget: {
      cellLabel:
        "Widget du tableau de bord : {title}. Utilisez les touches fléchées pour naviguer. Maintenez Alt enfoncée et appuyez sur une touche fléchée pour le déplacer.",
      ...
      appLoading: "Restauration de l’app…",
      appStaleTitle: "Cette app épinglée est obsolète",
      appStaleDetail:
        "Son serveur, sa ressource ou la transcription d’origine n’est plus disponible.",
      retry: "Réessayer",
      ...
      sandboxOriginRequired:
        "L’autorisation du widget a échoué après plusieurs tentatives d’actualisation. Si la Gateway s’exécute derrière un proxy inverse ou un tunnel qui n’achemine pas le port du bac à sable du widget, définissez mcp.apps.sandboxOrigin sur une origine publique dédiée acheminée vers l’écouteur du bac à sable.",
  ...
  workboard: {
    ...
    dashboardEmpty:
      "Aucun tableau de bord pour le moment — l’agent de travail peut épingler des widgets.",
    openSession: "Ouvrir la session",
  ...
  modelProviders: {
    ...
    globalUsage: "Utilisation globale et coût",
  ...
  chat: {
    ...
    board: {
      ...
      resetDescription:
        "Le contexte de la conversation est réinitialisé. Votre tableau de bord reste inchangé.",
    },
    catalog: {
    ...
    workspaceConflict: {
      ...
      titleMany: "{count} conflits d’espaces de travail cloud",
      description:
        "OpenClaw a conservé vos versions locales et appliqué les autres modifications du cloud. Inspectez le résultat indexé ou utilisez sa version pour un chemin en conflit.",
      ...
      commandHelp:
        "Exécutez ces commandes dans Bash ou zsh (Git Bash sous Windows). Si l’inspection indique que le chemin n’existe pas, le cloud l’a supprimé ; vérifiez et supprimez le chemin local manuellement. Si checkout signale un conflit de fichier/répertoire, déplacez ou supprimez le chemin local bloquant, puis réessayez. Si la réf. indexée est manquante, l’avis est obsolète ; ne modifiez pas le chemin local.",
      commandsUnavailable:
        "Ce nom de fichier contient des caractères de contrôle de terminal, donc OpenClaw ne générera pas de commande shell copiable pour celui-ci. Inspectez directement la réf. indexée et saisissez le chemin manuellement avec précaution.",
    ...
    messages: {
      ...
      rewindConfirm: "Revenir à avant ce message ?",
      rewindToHere: "Revenir jusqu’ici",
      rewindUnavailable: "Le retour en arrière n’est pas disponible pendant que l’agent travaille",
    ...
    composer: {
      ...
      cameraPageInactive: "Les caméras ne sont pas disponibles lorsque cette page est inactive.",
