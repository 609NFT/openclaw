...
export const ko: TranslationMap = {
  ...
  sessionsView: {
    ...
    cloudWorkerPlacementConflict: "클라우드 워커: {state} · 워크스페이스 충돌 1개",
    cloudWorkerPlacementConflicts: "클라우드 워커: {state} · 워크스페이스 충돌 {count}개",
    cloudWorkerDescendantConflict: "클라우드 워커 하위 항목: 워크스페이스 충돌 1개",
    cloudWorkerDescendantConflicts: "클라우드 워커 하위 항목: 워크스페이스 충돌 {count}개",
    ...
    invalidEmojiIcon: "이모지를 정확히 하나 입력하세요.",
    removeIcon: "아이콘 제거",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      displayName: "표시 이름",
      displayNamePlaceholder: "내 이름",
      saveProfile: "이름 저장",
      saving: "저장 중…",
      uploading: "처리 중…",
      profileHint:
        "JPEG, PNG 또는 WebP. 이미지는 중앙을 기준으로 잘라내고 512px로 크기 조정됩니다.",
  ...
  subtitles: {
    ...
    apps: "휴대폰, 시계, 데스크톱 및 브라우저용 컴패니언 앱.",
    ...
    notifications: "Gateway의 브라우저 푸시 알림.",
    security: "Gateway 인증, exec 정책, 도구 프로필 및 승인.",
    advanced: "나머지 모든 구성 섹션 및 원시 파일 편집기.",
    debug: "스냅샷, 이벤트, RPC.",
    logs: "실시간 Gateway 로그.",
  ...
  custodian: {
    ...
    history: {
      button: "기록",
      title: "최근 변경 사항",
      description: "이 시스템에서 변경된 내용입니다. 최신 항목이 먼저 표시됩니다.",
      loading: "최근 변경 사항 로드 중…",
      empty: "아직 기록된 변경 사항이 없습니다.",
      requestFailed: "OpenClaw가 변경 기록을 로드하지 못했습니다.",
      loadMore: "더 보기",
      loadingMore: "더 로드 중…",
    ...
    nudge: {
      ...
      channelAuth: "{channel} 인증 상태가 저하되었습니다 — 무슨 일이 있었는지 물어보세요",
  ...
  mcpServers: {
    ...
    nameInvalid: "서버 이름에는 문자, 숫자, 점, 대시 또는 밑줄을 사용할 수 있습니다.",
    targetInvalid: "HTTP 전송의 URL 또는 stdio의 유효한 명령줄을 입력하세요.",
    nameTaken: "“{name}”이라는 MCP server가 이미 존재합니다.",
    missing: "구성에서 MCP server “{name}”을(를) 찾을 수 없습니다.",
    missingTransport: "전송 누락",
    addedSuccess: "MCP server {name}을(를) 추가했습니다.",
    enabledSuccess: "MCP server {name}을(를) 활성화했습니다.",
    disabledSuccess: "MCP server {name}을(를) 비활성화했습니다.",
    removedSuccess: "MCP server {name}을(를) 제거했습니다.",
    configUnavailable: "구성을 사용할 수 없습니다. 새로 고친 후 다시 시도하세요.",
    connectRequired: "MCP server를 변경하려면 Gateway에 연결하세요.",
    adminRequired: "MCP server 변경에는 operator.admin 액세스가 필요합니다.",
    enable: "활성화",
    disable: "비활성화",
    removeNamed: "{name} 제거",
    working: "작업 중…",
  ...
  mcpPage: {
    connectorsLink: "Plugins 페이지에서 원클릭 connector를 살펴보세요.",
    servers: "서버",
    oauth: "OAuth",
    filtered: "필터링됨",
  ...
  labsPage: {
    ...
    sectionTitle: "실험적 기능",
    sectionDescription: "변경 사항은 즉시 저장되며 향후 agent 실행에 적용됩니다.",
    documentation: "문서",
    ...
    codeMode: {
      title: "코드 모드",
      description:
        "에이전트가 컴팩트한 샌드박스 JavaScript 워크플로에서 도구를 결합할 수 있게 합니다.",
    },
    swarm: {
      title: "스웜",
      description: "코드 모드가 하위 에이전트 그룹을 병렬로 조율할 수 있게 합니다.",
      empty: "활성 스웜이 없습니다.",
      defaultPhase: "단계 없음",
    },
  },
  ...
  appsPage: {
    ...
    heroTagline:
      "휴대폰, 시계, 데스크톱, 브라우저용 컴패니언 앱 — 그리고 에이전트가 할 수 있는 일을 확장하는 플러그인까지.",
    sectionMobile: "휴대폰에서",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "iOS에서 채팅하고, 말하고, 작업을 승인하고, OpenClaw로 공유하세요.",
      },
      android: {
        title: "Android",
        desc: "Android 휴대폰을 채팅, 카메라, Canvas를 갖춘 완전한 OpenClaw 노드로 사용하세요.",
      },
      appleWatch: {
        title: "Apple Watch",
        desc: "손목에서 한눈에 확인하는 채팅과 빠른 답장.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      plugins: {
        title: "Plugins 및 ClawHub",
        desc: "커뮤니티의 채널, 도구 및 Skills로 OpenClaw를 확장하세요.",
      },
    },
  },
  presence: {
  ...
  profilePage: {
    ...
    identity: {
      title: "ID",
      description: "이 Gateway의 내 프로필입니다.",
      loading: "내 아이덴티티를 불러오는 중…",
      profileUnavailable: "내 아이덴티티 프로필을 불러올 수 없습니다.",
      notSet: "아이덴티티가 설정되지 않았습니다.",
      setIdentity: "아이덴티티 설정",
      avatar: "아바타",
      ...
      openSettings: "{name}의 아이덴티티 설정 열기",
      avatarErrors: {
  ...
  board: {
    ...
    widget: {
      cellLabel:
        "대시보드 위젯: {title}. 화살표 키를 사용하여 이동하세요. Alt 키를 누른 상태에서 화살표 키를 눌러 이동할 수 있습니다.",
      moveHandle: "{title} 이동",
      ...
      appStaleDetail: "해당 서버, 리소스 또는 원본 트랜스크립트를 더 이상 사용할 수 없습니다.",
      retry: "재시도",
      frameResolverMissing: "위젯 콘텐츠를 사용할 수 없습니다.",
      sandboxUnavailable: "위젯 샌드박스 호스트를 사용할 수 없습니다.",
      frameAuthorizationFailed: "반복된 새로 고침 시도 후 위젯 인증에 실패했습니다.",
      sandboxOriginRequired:
        "반복된 새로 고침 시도 후 위젯 인증에 실패했습니다. Gateway가 위젯 샌드박스 포트를 라우팅하지 않는 리버스 프록시 또는 터널 뒤에서 실행되는 경우, mcp.apps.sandboxOrigin을 샌드박스 리스너로 라우팅되는 전용 공개 오리진으로 설정하세요.",
  ...
  chat: {
    ...
    board: {
      ...
      dockBottom: "채팅을 하단에 도킹",
      dockHidden: "채팅 숨기기",
      resizeDock: "채팅 도크 크기 조정",
      reopenChat: "채팅 표시",
      workboardCard: "워크보드 카드: {title}, {status}",
      defaultTab: "메인",
      mockPlaceholder: "보드 보기 경계 · {tabs}개 탭 · {widgets}개 위젯",
      mockOverview: "개요",
      mockResearch: "리서치",
      mockSessionStatus: "스레드 상태",
      mockRecentFindings: "최근 발견 사항",
      mockSourceMap: "소스 맵",
      resetTitle: "대화를 재설정하시겠습니까?",
      resetDescription: "대화 컨텍스트가 재설정됩니다. 대시보드는 그대로 유지됩니다.",
    },
    catalog: {
    ...
    workspaceConflict: {
      titleOne: "클라우드 작업 공간 충돌 1개",
      titleMany: "클라우드 작업 공간 충돌 {count}개",
      description:
        "OpenClaw가 로컬 버전을 유지하고 다른 클라우드 변경 사항을 적용했습니다. 스테이징된 결과를 검사하거나 충돌한 경로에 대해 해당 버전을 가져오세요.",
      morePaths: "+{count}개 경로 더 있음",
      ...
      commandHelp:
        "Bash 또는 zsh(Windows에서는 Git Bash)에서 실행하세요. inspect에서 경로가 존재하지 않는다고 표시되면 클라우드에서 삭제된 것이므로, 확인한 뒤 로컬 경로를 수동으로 제거하세요. checkout에서 파일/디렉터리 충돌이 보고되면 차단 중인 로컬 경로를 이동하거나 제거한 다음 다시 시도하세요. 스테이징된 ref가 없으면 알림이 오래된 것이므로 로컬 경로를 변경하지 마세요.",
      commandsUnavailable:
        "이 파일 이름에는 터미널 제어 문자가 포함되어 있으므로 OpenClaw는 복사 가능한 셸 명령을 만들지 않습니다. 스테이징된 ref를 직접 검사하고 주의해서 경로를 수동으로 입력하세요.",
      dismiss: "작업 공간 충돌 알림 닫기",
      eventSender: "클라우드 작업 공간",
      eventTitleOne: "1개의 충돌이 있는 클라우드 결과가 적용됨",
      eventTitleMany: "{count}개의 충돌이 있는 클라우드 결과가 적용됨",
      eventDescription:
    ...
    messages: {
      ...
      forkFromHere: "여기서 분기",
      hide: "숨기기",
      hideConfirm: "이 브라우저에서 이 메시지를 숨길까요? 에이전트는 계속 볼 수 있습니다.",
      hideMessage: "메시지 숨기기",
      ...
      rewind: "되돌리기",
      rewindConfirm: "이 메시지 이전으로 되돌릴까요?",
      rewindToHere: "여기로 되돌리기",
      rewindUnavailable: "에이전트가 작업 중일 때는 되돌리기를 사용할 수 없습니다",
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "컴포저 마이크 버튼을 길게 누르고 말한 다음, 손을 떼면 보내지 않고 텍스트를 삽입합니다.",
      ...
      dictationReleaseToInsert: "손을 떼면 받아쓰기 삽입",
    ...
    sessionDiscussion: {
      ...
      loading: "토론 로드 중…",
      opening: "토론 여는 중…",
      requiresWriteAccess: "이 토론을 열려면 Operator 쓰기 액세스 권한이 필요합니다.",
      opened: "세션 토론",
  ...
  cron: {
    ...
    form: {
      ...
      script: "스크립트",
      readOnlyPayloadHelp:
        "이 페이로드는 Control UI 외부에서 생성되었습니다. 해당 내용은 읽기 전용으로 유지되며 다른 변경 사항을 저장해도 보존됩니다.",
