...
export const es: TranslationMap = {
  ...
  sessionsView: {
    ...
    dashboardAvailable: "Dashboard disponible",
    ...
    cloudWorkerPlacementConflicts:
      "Trabajador en la nube: {state} · {count} conflictos de espacio de trabajo",
    cloudWorkerDescendantConflict:
      "Hijo de trabajador en la nube: 1 conflicto de espacio de trabajo",
    cloudWorkerDescendantConflicts:
      "Hijos de trabajador en la nube: {count} conflictos de espacio de trabajo",
  ...
  configView: {
    ...
    sidebarPrefs: {
      ...
      liveActivity: "Mostrar la actividad en directo del agente en la barra lateral",
      liveActivityHint:
  ...
  custodian: {
    ...
    connectionChanged:
      "La conexión del Gateway cambió. Vuelve a intentarlo para continuar con esta configuración.",
    sessionRestarted:
    ...
    history: {
      ...
      description: "Qué cambió en este sistema, de más reciente a más antiguo.",
    ...
    nudge: {
      ...
      channelAuth: "La autenticación de {channel} está degradada — pregúntame qué ocurrió",
      channelDisconnected: "{channel} acaba de desconectarse — pregúntame qué ocurrió",
      channelDegraded: "{channel} está degradado — pregúntame qué ocurrió",
  ...
  mcpServers: {
    ...
    transportStreamableHttp: "HTTP transmitible",
    transportSse: "SSE",
  ...
  mcpPage: {
    connectorsLink: "Descubre conectores de un clic en la página Plugins.",
    servers: "Servidores",
    oauth: "OAuth",
    filtered: "Filtrado",
  ...
  labsPage: {
    ...
    sectionDescription:
      "Los cambios se guardan inmediatamente y se aplican a futuras ejecuciones de agentes.",
    ...
    codeMode: {
      title: "Modo Código",
      description:
        "Permite que los agentes combinen herramientas en flujos de trabajo JavaScript compactos y aislados.",
    },
    swarm: {
      title: "Enjambre",
      description: "Permite que Modo Código coordine grupos de subagentes en paralelo.",
  ...
  appsPage: {
    ...
    cards: {
      ...
      macos: {
        title: "macOS",
        desc: "Complemento de la barra de menús para tu Gateway — notificaciones, aprobaciones, chat rápido.",
      },
      windows: {
        title: "Windows",
      ...
      plugins: {
        ...
        desc: "Extiende OpenClaw con canales, herramientas y Skills de la comunidad.",
      },
    },
  },
  presence: {
  ...
  gatewayLogs: {
    title: "Registros",
    subtitle: "Registros de archivos de Gateway (JSONL).",
  ...
  board: {
    ...
    actionInProgress: "Aún se está guardando otro cambio en el panel.",
    announcement: {
    ...
    widget: {
      cellLabel:
        "Widget del panel: {title}. Usa las teclas de flecha para navegar. Mantén pulsada la tecla Alt y pulsa una tecla de flecha para moverlo.",
      ...
      frameAuthorizationFailed:
        "La autorización del widget falló tras repetidos intentos de actualización.",
      sandboxOriginRequired:
        "La autorización del widget falló tras repetidos intentos de actualización. Si el gateway se ejecuta detrás de un proxy inverso o túnel que no enruta el puerto del entorno aislado del widget, configura mcp.apps.sandboxOrigin en un origen público dedicado enrutado al listener del entorno aislado.",
      errorTitle: "Este widget no se pudo cargar",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchRequiresAdmin: "Cambiar de rama requiere acceso de administrador del operador.",
    ...
    board: {
      ...
      resizeDock: "Redimensionar el panel del chat",
      reopenChat: "Mostrar chat",
      workboardCard: "Tarjeta del tablero de trabajo: {title}, {status}",
      defaultTab: "Principal",
      mockPlaceholder: "Unión de la vista de tablero · {tabs} pestañas · {widgets} widgets",
    ...
    workspaceConflict: {
      ...
      description:
        "OpenClaw conservó tus versiones locales y aplicó los demás cambios en la nube. Revisa el resultado preparado o toma su versión para una ruta con conflicto.",
      morePaths: "+{count} rutas más",
      stagedResult: "Resultado en la nube preparado",
      ...
      commandHelp:
        "Ejecuta estos en Bash o zsh (Git Bash en Windows). Si inspect indica que la ruta no existe, la nube la eliminó; verifica y elimina la ruta local manualmente. Si checkout informa de un conflicto de archivo/directorio, mueve o elimina la ruta local que bloquea y vuelve a intentarlo. Si falta la referencia preparada, el aviso está obsoleto; no cambies la ruta local.",
      commandsUnavailable:
        "Este nombre de archivo contiene caracteres de control de terminal, por lo que OpenClaw no creará un comando de shell copiable para él. Inspecciona la referencia preparada directamente e introduce la ruta manualmente con cuidado.",
    ...
    messages: {
      ...
      rewindUnavailable: "Rewind no está disponible mientras el agente está trabajando",
      forkUnavailable: "Fork no está disponible mientras el agente está trabajando",
    ...
    composer: {
      ...
      holdToRecordSetting: "Mantener presionado el botón del micrófono para dictar",
      holdToRecordSettingDescription:
        "Mantén presionado el botón del micrófono del compositor, habla y luego suéltalo para insertar texto sin enviarlo.",
      ...
      selectedCameraUnavailable:
        "La cámara seleccionada no está disponible. Elige otra cámara o Predeterminada del sistema.",
      ...
      turnCameraOff: "Desactivar cámara",
  ...
  cron: {
    ...
    form: {
      ...
      script: "Script",
      readOnlyPayloadHelp:
        "Esta carga útil se creó fuera de Control UI. Su contenido permanece como solo lectura y se conserva cuando guardas otros cambios.",
