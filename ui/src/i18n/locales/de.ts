...
export const de: TranslationMap = {
  ...
  sessionsView: {
    ...
    cloudWorkerDescendantConflict: "Cloud worker child: 1 Workspace-Konflikt",
    cloudWorkerDescendantConflicts: "Cloud worker children: {count} Workspace-Konflikte",
  ...
  configView: {
    ...
    syncedHint: "Über die Gateway auf Ihren Geräten synchronisiert.",
    notifications: {
    ...
    sidebarPrefs: {
      title: "Seitenleiste",
      hint: "Wählen Sie aus, was angezeigt wird, während Sitzungen ausgeführt werden.",
      liveActivity: "Live-Agentenaktivität in der Seitenleiste anzeigen",
      liveActivityHint:
        "Die neueste Aktivität des Assistenten oder Tools unter laufenden Sitzungen anzeigen.",
    },
    connection: {
      title: "Verbindung",
      gateway: "Gateway",
  ...
  subtitles: {
    ...
    notifications: "Browser-Push-Benachrichtigungen von Ihrer Gateway.",
  ...
  custodian: {
    ...
    nudge: {
      configReload: "Neuladen der Konfiguration wurde angehalten — frag mich, was passiert ist",
  ...
  mcpServers: {
    ...
    connectRequired: "Verbinden Sie sich mit der Gateway, um MCP-Server zu ändern.",
  ...
  mcpPage: {
    connectorsLink: "Entdecken Sie One-Click-Connectors auf der Plugins-Seite.",
    servers: "Server",
    oauth: "OAuth",
    filtered: "Gefiltert",
  ...
  labsPage: {
    intro:
      "Labs enthält experimentelle Funktionen, die sich zwischen Releases ändern, nicht mehr funktionieren oder verschwinden können.",
    ...
    restartRequired: "Neustart der Gateway erforderlich.",
    ...
    swarm: {
      title: "Schwarm",
      description: "Lassen Sie den Code-Modus Gruppen von Subagenten parallel orchestrieren.",
      empty: "Keine aktiven Schwärme.",
  ...
  appsPage: {
    ...
    heroTagline:
      "Begleit-Apps für Ihr Smartphone, Ihre Uhr, Ihren Desktop und Ihren Browser — plus Plugins, um zu erweitern, was Ihr Agent tun kann.",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Chatten, sprechen, Aktionen genehmigen und Inhalte von iOS aus in OpenClaw teilen.",
      },
      android: {
        title: "Android",
        desc: "Dein Android-Smartphone als vollständiger OpenClaw-Knoten — Chat, Kamera und Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
      ...
      wearOs: {
        title: "Wear OS",
        desc: "Der Android-Companion erweitert OpenClaw auf deine Uhr.",
      },
      macos: {
        title: "macOS",
        desc: "Menüleisten-Companion für dein Gateway — Benachrichtigungen, Genehmigungen, Schnellchat.",
      },
      windows: {
        title: "Windows",
        desc: "Der Windows-Companion verbindet deinen PC als OpenClaw-Knoten.",
      },
      linux: {
        title: "Linux",
  ...
  gatewayLogs: {
    ...
    filter: "Filter",
    searchPlaceholder: "Protokolle suchen",
    autoFollow: "Automatisch folgen",
    file: "Datei: {file}",
    truncated: "Protokollausgabe gekürzt; der neueste Ausschnitt wird angezeigt.",
  ...
  board: {
    ...
    emptyHint:
      "Ihr Agent kann hier Widgets anheften — bitten Sie ihn zum Beispiel um eine Statuskarte.",
    ...
    widget: {
      cellLabel:
        "Dashboard-Widget: {title}. Verwenden Sie die Pfeiltasten zum Navigieren. Halten Sie Alt gedrückt und drücken Sie eine Pfeiltaste, um es zu verschieben.",
      ...
      sandboxOriginRequired:
        "Widget-Autorisierung nach wiederholten Aktualisierungsversuchen fehlgeschlagen. Wenn die Gateway hinter einem Reverse-Proxy oder Tunnel ausgeführt wird, der den Widget-Sandbox-Port nicht weiterleitet, legen Sie mcp.apps.sandboxOrigin auf einen dedizierten öffentlichen Ursprung fest, der zum Sandbox-Listener weitergeleitet wird.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchUnavailable:
        "Der Wechsel des Zweigs ist nicht verfügbar, während der Agent arbeitet.",
      branchSwitchRequiresAdmin: "Das Wechseln von Zweigen erfordert Operator-Adminzugriff.",
    ...
    board: {
      ...
      resizeDock: "Chat-Dockgröße ändern",
    ...
    workspaceConflict: {
      ...
      description:
        "OpenClaw hat Ihre lokalen Versionen beibehalten und die anderen Cloud-Änderungen angewendet. Prüfen Sie das bereitgestellte Ergebnis oder übernehmen Sie dessen Version für einen konfliktbehafteten Pfad.",
      ...
      commandHelp:
        "Führen Sie diese Befehle in Bash oder zsh aus (Git Bash unter Windows). Wenn inspect meldet, dass der Pfad nicht existiert, wurde er von der Cloud gelöscht; überprüfen Sie dies und entfernen Sie den lokalen Pfad manuell. Wenn checkout einen Datei-/Verzeichniskonflikt meldet, verschieben oder entfernen Sie den blockierenden lokalen Pfad und versuchen Sie es erneut. Wenn die staged ref fehlt, ist der Hinweis veraltet; ändern Sie den lokalen Pfad nicht.",
      commandsUnavailable:
        "Dieser Dateiname enthält Terminal-Steuerzeichen, daher erstellt OpenClaw dafür keinen kopierbaren Shell-Befehl. Prüfen Sie die staged ref direkt und geben Sie den Pfad sorgfältig manuell ein.",
      dismiss: "Hinweis zu Workspace-Konflikt schließen",
    ...
    questions: {
      ...
      answeredElsewhere: "An anderer Stelle beantwortet",
      unavailable: "Nicht verfügbar",
      expired: "Abgelaufen",
      cancelled: "Abgebrochen",
    },
    ...
    composer: {
      ...
      microphoneAppliesNextSession:
        "Änderungen werden übernommen, wenn Sie Ihre nächste Talk-Sitzung starten.",
      microphoneListUnsupported: "Dieser Browser kann Mikrofoneingänge nicht auflisten.",
      noCameras: "Keine zusätzlichen Kameras gefunden",
      ...
      holdToRecordSetting: "Mikrofontaste gedrückt halten, um zu diktieren",
      holdToRecordSettingDescription:
        "Halten Sie die Mikrofontaste im Composer gedrückt, sprechen Sie und lassen Sie sie dann los, um Text einzufügen, ohne ihn zu senden.",
      dictationAudioUnsupported:
        "Die Gateway hat ein nicht unterstütztes Diktat-Audioformat zurückgegeben.",
      dictationBrowserAudioUnsupported:
        "Dieser Browser kann Diktat-Audio nicht mit 8 kHz aufnehmen.",
      dictationConnecting: "Diktat wird gestartet…",
      dictationDisconnected: "Das Diktat wurde beendet, weil die Gateway getrennt wurde.",
      dictationFailed: "Diktat fehlgeschlagen.",
      dictationFinalizing: "Diktat wird abgeschlossen…",
      dictationFinalizationTimedOut:
        "Das Diktat wurde beendet, bevor das letzte teilweise Transkript finalisiert werden konnte.",
      ...
      selectedCameraUnavailable:
        "Die ausgewählte Kamera ist nicht verfügbar. Wählen Sie eine andere Kamera oder die Systemvoreinstellung.",
    ...
    sessionDiscussion: {
      ...
      requiresWriteAccess:
        "Operator-Schreibzugriff ist erforderlich, um diese Diskussion zu öffnen.",
  ...
  cron: {
    ...
    form: {
      ...
      script: "Skript",
      readOnlyPayloadHelp:
        "Diese Payload wurde außerhalb der Control UI erstellt. Ihre Inhalte bleiben schreibgeschützt und werden beibehalten, wenn Sie andere Änderungen speichern.",
