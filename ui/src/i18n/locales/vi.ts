...
export const vi: TranslationMap = {
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileHint:
        "JPEG, PNG, hoặc WebP. Hình ảnh được cắt giữa và thay đổi kích thước thành 512px.",
  ...
  subtitles: {
    ...
    labs: "Khả năng thử nghiệm của tác nhân và công cụ.",
  ...
  custodian: {
    ...
    earlier: "Trước đó",
    requestFailed: "OpenClaw không thể phản hồi. Vui lòng thử lại.",
  ...
  labsPage: {
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "Cho phép agent kết hợp các công cụ trong quy trình JavaScript nhỏ gọn, được đóng hộp cát.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Trò chuyện nhanh và trả lời tức thì ngay trên cổ tay bạn.",
      },
      wearOs: {
        title: "Wear OS",
  ...
  profilePage: {
    ...
    identity: {
      ...
      avatarErrors: {
        invalid: "Không thể xử lý ảnh đó.",
        sourceTooLarge: "Chọn ảnh có kích thước 10 MB hoặc nhỏ hơn.",
        tooLarge: "Ảnh đại diện sau xử lý lớn hơn 512 KB.",
      },
    },
  },
  tasksPage: {
  ...
  board: {
    ...
    widget: {
      cellLabel:
        "Widget bảng điều khiển: {title}. Dùng phím mũi tên để di chuyển. Giữ Alt và nhấn phím mũi tên để di dời.",
      ...
      sandboxOriginRequired:
        "Ủy quyền widget thất bại sau nhiều lần thử làm mới. Nếu Gateway chạy sau reverse proxy hoặc tunnel không định tuyến cổng sandbox của widget, hãy đặt mcp.apps.sandboxOrigin thành một origin công khai riêng được định tuyến tới trình lắng nghe sandbox.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchUnavailable: "Không thể chuyển nhánh khi agent đang hoạt động.",
      branchSwitchRequiresAdmin: "Việc chuyển nhánh yêu cầu quyền truy cập quản trị viên vận hành.",
    ...
    board: {
      ...
      dockMenu: "Ngăn chat: {dock}",
      dockLeft: "Ghim chat bên trái",
      dockRight: "Ghim chat bên phải",
      dockBottom: "Ghim chat bên dưới",
      dockHidden: "Ẩn chat",
      resizeDock: "Thay đổi kích thước ngăn chat",
      reopenChat: "Hiện chat",
    ...
    workspaceConflict: {
      ...
      description:
        "OpenClaw đã giữ các phiên bản cục bộ của bạn và áp dụng các thay đổi khác trên đám mây. Kiểm tra kết quả đã dàn dựng hoặc lấy phiên bản của nó cho một đường dẫn bị xung đột.",
      ...
      commandHelp:
        "Chạy các lệnh này trong Bash hoặc zsh (Git Bash trên Windows). Nếu inspect báo rằng đường dẫn không tồn tại, đám mây đã xóa nó; hãy xác minh và xóa đường dẫn cục bộ theo cách thủ công. Nếu checkout báo xung đột tệp/thư mục, hãy di chuyển hoặc xóa đường dẫn cục bộ đang chặn, rồi thử lại. Nếu tham chiếu đã dàn dựng bị thiếu, thông báo đã lỗi thời; đừng thay đổi đường dẫn cục bộ.",
      commandsUnavailable:
        "Tên tệp này chứa các ký tự điều khiển terminal, nên OpenClaw sẽ không tạo lệnh shell có thể sao chép cho nó. Hãy kiểm tra trực tiếp tham chiếu đã dàn dựng và nhập đường dẫn thủ công một cách cẩn thận.",
      ...
      eventTitleMany: "Kết quả trên đám mây đã áp dụng với {count} xung đột",
      eventDescription:
        "Các phiên bản cục bộ được giữ lại cho những đường dẫn này; các thay đổi khác trên đám mây đã được áp dụng.",
    },
    compaction: {
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Giữ nút micro trong khung soạn thảo, nói, rồi thả ra để chèn văn bản mà không gửi.",
      ...
      dictationDisconnected: "Đã dừng đọc chính tả vì Gateway ngắt kết nối.",
      dictationFailed: "Đọc chính tả thất bại.",
      dictationFinalizing: "Đang hoàn tất đọc chính tả…",
      dictationFinalizationTimedOut:
        "Đã dừng đọc chính tả trước khi bản chép cuối cùng có thể được hoàn tất.",
