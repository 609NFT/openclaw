...
export const id: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      loggedOut: "Telah logout.",
      logoutNotCleared:
        "Tidak ada sesi WhatsApp tersimpan yang dihapus. Sesi mungkin sudah tidak ada, atau direktori autentikasinya mungkin memerlukan pembersihan manual.",
    },
  ...
  agentChip: {
    ...
    offlineOpenSettings: "Offline — buka Settings",
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime: "Cloud workers memerlukan runtime OpenClaw; {runtime} dipilih.",
  ...
  sessionsView: {
    ...
    cloudWorkerDescendantConflict: "Turunan cloud worker: 1 konflik ruang kerja",
    cloudWorkerDescendantConflicts: "Turunan cloud worker: {count} konflik ruang kerja",
  ...
  custodian: {
    ...
    history: {
      ...
      description: "Perubahan pada sistem ini, yang terbaru lebih dulu.",
      ...
      opaqueChange:
        "Pemformatan atau komentar berubah tanpa perubahan jalur konfigurasi yang terlihat.",
      sources: {
  ...
  labsPage: {
    ...
    sectionDescription: "Perubahan disimpan segera dan diterapkan pada eksekusi agen mendatang.",
    ...
    swarm: {
      title: "Swarm",
      description: "Biarkan Mode Kode mengorkestrasi grup subagen secara paralel.",
  ...
  appsPage: {
    ...
    cards: {
      ...
      android: {
        title: "Android",
        desc: "Ponsel Android Anda sebagai node OpenClaw lengkap — chat, kamera, dan Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
        desc: "Chat yang mudah dilihat sekilas dan balasan cepat dari pergelangan tangan Anda.",
      },
      wearOs: {
        title: "Wear OS",
  ...
  board: {
    ...
    widget: {
      cellLabel:
        "Widget dasbor: {title}. Gunakan tombol panah untuk bernavigasi. Tahan Alt dan tekan tombol panah untuk memindahkannya.",
      ...
      appLoading: "Memulihkan app…",
      appStaleTitle: "App yang disematkan ini sudah kedaluwarsa",
      ...
      frameAuthorizationFailed: "Otorisasi widget gagal setelah upaya penyegaran berulang.",
      sandboxOriginRequired:
        "Otorisasi widget gagal setelah upaya penyegaran berulang. Jika gateway berjalan di belakang proksi balik atau tunnel yang tidak merutekan port sandbox widget, atur mcp.apps.sandboxOrigin ke origin publik khusus yang dirutekan ke listener sandbox.",
      errorTitle: "Widget ini tidak dapat dimuat",
      errorDetail: "Masalahnya terbatas pada kartu ini.",
  ...
  workboard: {
    ...
    dashboardEmpty: "Belum ada dasbor — agen kerja dapat menyematkan widget.",
    openSession: "Buka sesi",
  ...
  chat: {
    ...
    board: {
      ...
      dockLeft: "Dock chat di kiri",
      dockRight: "Dock chat di kanan",
      dockBottom: "Dock chat di bawah",
    ...
    workspaceConflict: {
      ...
      description:
        "OpenClaw mempertahankan versi lokal Anda dan menerapkan perubahan cloud lainnya. Periksa hasil yang sudah di-stage atau ambil versinya untuk path yang berkonflik.",
      morePaths: "+{count} path lainnya",
      stagedResult: "Hasil cloud yang sudah di-stage",
      copyStagedResult: "Salin ref hasil staged",
      ...
      commandHelp:
        "Jalankan ini di Bash atau zsh (Git Bash di Windows). Jika inspect mengatakan path tidak ada, cloud telah menghapusnya; verifikasi dan hapus path lokal secara manual. Jika checkout melaporkan konflik file/direktori, pindahkan atau hapus path lokal yang memblokir, lalu coba lagi. Jika ref staged hilang, pemberitahuan sudah kedaluwarsa; jangan ubah path lokal.",
      commandsUnavailable:
        "Nama file ini berisi karakter kontrol terminal, sehingga OpenClaw tidak akan membuat perintah shell yang dapat disalin untuknya. Periksa ref staged secara langsung dan masukkan path secara manual dengan hati-hati.",
    ...
    messages: {
      activity: "Aktivitas",
      copySelection: "Salin",
      forkFromHere: "Buat fork dari sini",
      hide: "Sembunyikan",
      ...
      rewind: "Putar balik",
      rewindConfirm: "Putar balik ke sebelum pesan ini?",
      rewindToHere: "Putar balik ke sini",
      rewindUnavailable: "Putar balik tidak tersedia saat agen sedang bekerja",
    ...
    modelControls: {
      ...
      resetToDefault: "Reset ke default ({model})",
    },
    sideChat: {
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Tahan tombol mikrofon penulis, bicara, lalu lepaskan untuk menyisipkan teks tanpa mengirim.",
