...
export const nl: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      loggedOut: "Afgemeld.",
      logoutNotCleared:
        "Er is geen opgeslagen WhatsApp-sessie gewist. Mogelijk is deze al afwezig, of moet de auth-map handmatig worden opgeruimd.",
    },
  ...
  sessionsView: {
    ...
    cloudWorkerDescendantConflict: "Cloud worker-onderliggend: 1 werkruimteconflict",
    cloudWorkerDescendantConflicts: "Cloud worker-onderliggend: {count} werkruimteconflicten",
  ...
  configView: {
    ...
    sidebarPrefs: {
      ...
      liveActivityHint: "Toon de recentste assistent- of tooactiviteit onder actieve sessies.",
    },
    connection: {
      title: "Verbinding",
      gateway: "Gateway",
  ...
  execApproval: {
    ...
    otherPending: "Overige lopende verzoeken",
  ...
  custodian: {
    ...
    sessionRestarted:
      "{error} OpenClaw is een nieuwe sessie gestart; eerdere berichten blijven behouden voor context.",
    ...
    nudge: {
      ...
      channelAuth: "Authenticatie van {channel} verslechterd — vraag me wat er is gebeurd",
  ...
  board: {
    ...
    widget: {
      cellLabel:
        "Dashboardwidget: {title}. Gebruik de pijltjestoetsen om te navigeren. Houd Alt ingedrukt en druk op een pijltjestoets om te verplaatsen.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchUnavailable:
        "Wisselen van vertakking is niet beschikbaar terwijl de agent werkt.",
      branchSwitchRequiresAdmin: "Wisselen van vertakking vereist operator-adminrechten.",
    ...
    workspaceConflict: {
      ...
      description:
        "OpenClaw heeft je lokale versies behouden en de andere cloudwijzigingen toegepast. Bekijk het klaargezette resultaat of neem de versie ervan over voor een conflicterend pad.",
      morePaths: "+{count} meer paden",
      stagedResult: "Klaargezet cloudresultaat",
      ...
      commandsUnavailable:
        "Deze bestandsnaam bevat terminalstuurtekens, dus OpenClaw maakt er geen kopieerbaar shellcommando voor aan. Inspecteer de staged ref rechtstreeks en voer het pad zorgvuldig handmatig in.",
      dismiss: "Melding over workspaceconflict sluiten",
    ...
    modelControls: {
      ...
      usingDefault: "Standaardwaarde uit Instellingen wordt gebruikt",
    ...
    composer: {
      ...
      microphoneAppliesNextSession:
        "Wijzigingen worden toegepast wanneer je de volgende Talk-sessie start.",
      ...
      dictationAudioUnsupported:
        "De Gateway heeft een niet-ondersteund dictatie-audioformaat geretourneerd.",
      dictationBrowserAudioUnsupported: "Deze browser kan geen dictatie-audio op 8 kHz vastleggen.",
      dictationConnecting: "Dictatie starten…",
      dictationDisconnected: "Dictatie gestopt omdat de Gateway de verbinding heeft verbroken.",
      dictationFailed: "Dictaat mislukt.",
      dictationFinalizing: "Dictaat afronden…",
      dictationFinalizationTimedOut:
        "Dictaat gestopt voordat het laatste gedeeltelijke transcript kon worden afgerond.",
    ...
    toolCards: {
      ...
      widgetExportFailed: "Widget exporteren mislukt. Probeer opnieuw.",
