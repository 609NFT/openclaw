...
export const pt_BR: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Nenhuma sessão armazenada do WhatsApp foi limpa. Ela pode já estar ausente, ou o diretório de autenticação pode exigir limpeza manual.",
    },
  ...
  sessionsView: {
    ...
    cloudWorkerPlacementConflict: "Cloud worker: {state} · 1 conflito de workspace",
    cloudWorkerPlacementConflicts: "Cloud worker: {state} · {count} conflitos de workspace",
    cloudWorkerDescendantConflict: "Filho do cloud worker: 1 conflito de workspace",
    cloudWorkerDescendantConflicts: "Filhos do cloud worker: {count} conflitos de workspace",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileHint:
        "JPEG, PNG ou WebP. As imagens são recortadas ao centro e redimensionadas para 512 px.",
  ...
  configView: {
    ...
    syncedHint: "Sincronizado entre seus dispositivos pelo Gateway.",
    notifications: {
  ...
  subtitles: {
    ...
    apps: "Apps complementares para celular, relógio, desktop e navegador.",
  ...
  custodian: {
    ...
    requestFailed: "OpenClaw não conseguiu responder. Tente novamente.",
    connectionChanged:
      "A conexão do Gateway mudou. Tente novamente para continuar esta configuração.",
    sessionRestarted:
      "{error} OpenClaw iniciou uma nova sessão; as mensagens anteriores permanecem como contexto.",
    ...
    history: {
      ...
      requestFailed: "OpenClaw não conseguiu carregar o histórico de alterações.",
      loadMore: "Carregar mais",
      loadingMore: "Carregando mais…",
      changedPaths: "Caminhos alterados ({count})",
      invalidEdit: "Esta edição manual não passou na validação da configuração.",
      opaqueChange:
        "A formatação ou os comentários foram alterados sem mudanças visíveis nos caminhos de configuração.",
      sources: {
    ...
    nudge: {
      configReload:
        "O recarregamento da configuração foi interrompido — pergunte-me o que aconteceu",
      channelAuth: "A autenticação de {channel} está degradada — pergunte-me o que aconteceu",
  ...
  mcpServers: {
    ...
    transportStreamableHttp: "HTTP transmitível",
    transportSse: "SSE",
    transportStdio: "Stdio",
    targetLabel: "URL ou comando",
    nameInvalid: "Nomes de servidor usam letras, números, pontos, hifens ou sublinhados.",
    targetInvalid:
      "Insira uma URL para transportes HTTP ou uma linha de comando válida para stdio.",
    nameTaken: "Um servidor MCP chamado “{name}” já existe.",
  ...
  mcpPage: {
    connectorsLink: "Descubra conectores com um clique na página Plugins.",
    servers: "Servidores",
    oauth: "OAuth",
    filtered: "Filtrado",
  ...
  labsPage: {
    intro:
      "Labs contém recursos experimentais que podem mudar, falhar ou desaparecer entre versões.",
    ...
    restartRequired: "Reinicialização do Gateway necessária.",
    saveErrorTitle: "Não foi possível atualizar o recurso",
    saveFailed: "Não foi possível salvar a configuração do recurso.",
    codeMode: {
      title: "Modo Código",
      description:
        "Permita que agentes combinem ferramentas em fluxos de trabalho JavaScript compactos e em sandbox.",
    },
    swarm: {
      title: "Enxame",
  ...
  appsPage: {
    ...
    pairDevice: "Emparelhar seu dispositivo",
    sectionWatch: "No seu pulso",
    sectionDesktop: "No seu desktop",
    sectionBrowser: "No seu navegador",
    sectionCommunity: "Comunidade",
    badgeBundledIos: "Incluído com o app para iOS",
    badgeBundledAndroid: "Incluído com o app para Android",
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Chats rápidos de visualizar e respostas rápidas pelo seu pulso.",
      },
      wearOs: {
        title: "Wear OS",
        desc: "O app complementar para Android estende o OpenClaw para o seu relógio.",
      },
      macos: {
        title: "macOS",
        desc: "App complementar na barra de menus para o seu Gateway — notificações, aprovações, chat rápido.",
      },
      windows: {
        title: "Windows",
        desc: "O app complementar para Windows conecta seu PC como um nó OpenClaw.",
      },
      linux: {
        title: "Linux",
        desc: "App nativo para desktop — builds .deb e AppImage.",
      },
      chrome: {
        title: "Extensão do Chrome",
        desc: "Permita que o OpenClaw controle seu Chrome existente — abas, páginas e formulários.",
      },
      plugins: {
  ...
  board: {
    ...
    widget: {
      ...
      sandboxUnavailable: "O host da sandbox do widget não está disponível.",
      frameAuthorizationFailed:
        "A autorização do widget falhou após repetidas tentativas de atualização.",
      sandboxOriginRequired:
        "A autorização do widget falhou após repetidas tentativas de atualização. Se o gateway estiver sendo executado atrás de um proxy reverso ou túnel que não roteia a porta da sandbox do widget, defina mcp.apps.sandboxOrigin como uma origem pública dedicada roteada para o listener da sandbox.",
      errorTitle: "Este widget não pôde ser carregado",
  ...
  workboard: {
    ...
    dashboardEmpty: "Ainda não há dashboard — o agente de trabalho pode fixar widgets.",
    openSession: "Abrir sessão",
  ...
  chat: {
    ...
    board: {
      ...
      mockPlaceholder: "Emenda da visualização do quadro · {tabs} abas · {widgets} widgets",
      ...
      resetDescription: "O contexto da conversa será redefinido. Seu dashboard permanece.",
    },
    catalog: {
    ...
    workspaceConflict: {
      ...
      morePaths: "+{count} caminhos a mais",
      ...
      commandHelp:
        "Execute estes comandos no Bash ou zsh (Git Bash no Windows). Se a inspeção disser que o caminho não existe, a nuvem o excluiu; verifique e remova o caminho local manualmente. Se o checkout relatar um conflito de arquivo/diretório, mova ou remova o caminho local que está bloqueando e tente novamente. Se a ref preparada estiver ausente, o aviso está desatualizado; não altere o caminho local.",
      commandsUnavailable:
        "Este nome de arquivo contém caracteres de controle do terminal, então o OpenClaw não criará um comando de shell copiável para ele. Inspecione a ref preparada diretamente e insira o caminho manualmente com cuidado.",
    ...
    messages: {
      ...
      forkFromHere: "Criar fork a partir daqui",
      hide: "Ocultar",
      hideConfirm: "Ocultar esta mensagem neste navegador? O agente ainda a verá.",
      ...
      forkUnavailable: "Não é possível criar fork enquanto o agente está trabalhando",
    ...
    modelControls: {
      ...
      usingDefault: "Usando padrão das Configurações",
    ...
    composer: {
      ...
      microphoneAppliesNextSession:
        "As alterações serão aplicadas quando você iniciar sua próxima sessão de Talk.",
      ...
      holdToRecordSetting: "Segurar o botão do microfone para ditar",
    ...
    sessionDiscussion: {
      ...
      requiresWriteAccess: "É necessário acesso de gravação de operador para abrir esta discussão.",
