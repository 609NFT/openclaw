...
export const uk: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Жоден збережений сеанс WhatsApp не було очищено. Можливо, він уже відсутній або його каталог auth потребує ручного очищення.",
    },
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "Для хмарних воркерів потрібне середовище виконання OpenClaw; вибрано {runtime}.",
  ...
  sessionsView: {
    ...
    cloudWorkerPlacementConflict: "Хмарний працівник: {state} · 1 конфлікт робочого простору",
    cloudWorkerPlacementConflicts:
      "Хмарний працівник: {state} · {count} конфліктів робочого простору",
    cloudWorkerDescendantConflict: "Дочірній хмарний працівник: 1 конфлікт робочого простору",
    cloudWorkerDescendantConflicts:
      "Дочірні хмарні працівники: {count} конфліктів робочого простору",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      saving: "Збереження…",
      uploading: "Обробка…",
      profileHint: "JPEG, PNG або WebP. Зображення обрізаються по центру та змінюються до 512px.",
  ...
  configView: {
    ...
    notifications: {
      ...
      openSystemSettings: "Відкрити System Settings",
      blockedHint:
        "Сповіщення заблоковано. Оновіть дозволи сайту в браузері, щоб дозволити сповіщення.",
      nativeBlockedHint:
        "Сповіщення для OpenClaw вимкнено в macOS. Дозвольте їх у System Settings > Notifications.",
    },
    appearance: {
      theme: "Тема",
    ...
    sidebarPrefs: {
      title: "Бічна панель",
      hint: "Виберіть, що відображається під час виконання сеансів.",
  ...
  subtitles: {
    ...
    custodian: "Налаштування й обслуговування системи.",
  ...
  custodian: {
    ...
    subtitleCaretaker: "Налаштування й обслуговування системи.",
    exitSetup: "Вийти з налаштування",
    newAgent: "Новий агент",
    hatchDraft: "Прокидайся, друже!",
    placeholder: "Повідомлення OpenClaw…",
    ...
    connectionChanged:
      "Підключення Gateway змінилося. Повторіть спробу, щоб продовжити це налаштування.",
    sessionRestarted:
    ...
    nudge: {
      configReload: "Перезавантаження конфігурації зупинилося — запитайте мене, що сталося",
      ...
      channelDegraded: "Робота {channel} погіршилася — запитайте мене, що сталося",
  ...
  mcpServers: {
    ...
    nameInvalid: "Імена серверів мають містити літери, цифри, крапки, дефіси або підкреслення.",
    targetInvalid: "Введіть URL для HTTP-транспортів або дійсний командний рядок для stdio.",
    ...
    connectRequired: "Підключіться до Gateway, щоб змінювати MCP-сервери.",
    adminRequired: "Для змін MCP-сервера потрібен доступ operator.admin.",
    enable: "Увімкніть",
    disable: "Вимкнути",
  ...
  labsPage: {
    ...
    swarm: {
      title: "Рій",
      description: "Дозвольте режиму коду оркеструвати групи субагентів паралельно.",
  ...
  appsPage: {
    ...
    heroTagline:
      "Супутні застосунки для телефона, годинника, комп’ютера та браузера — а також плагіни, що розширюють можливості вашого агента.",
    sectionMobile: "На телефоні",
    havePhone: "Уже маєте застосунок?",
    pairDevice: "Спарити пристрій",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Спілкуйтеся в чаті, розмовляйте, схвалюйте дії та діліться в OpenClaw з iOS.",
      },
      android: {
        title: "Android",
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Зручні для швидкого перегляду чати та швидкі відповіді з вашого зап’ястя.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      macos: {
        title: "macOS",
        desc: "Супутній застосунок у рядку меню для вашого Gateway — сповіщення, схвалення, швидкий чат.",
      },
      windows: {
        title: "Windows",
      ...
      linux: {
        title: "Linux",
        desc: "Нативний настільний застосунок — збірки .deb і AppImage.",
      },
      chrome: {
  ...
  profilePage: {
    ...
    identity: {
      ...
      setIdentity: "Установити ідентичність",
      avatar: "Аватар",
      avatarDescription: "PNG, JPEG або WebP. Зображення змінюються до 256 × 256 або менше.",
      ...
      linkedEmailsDescription: "Адреси електронної пошти, підключені до цього профілю.",
  ...
  gatewayLogs: {
    ...
    exportLabels: {
      filtered: "відфільтроване",
      visible: "видимо",
    },
    filter: "Фільтр",
    searchPlaceholder: "Пошук у журналах",
    autoFollow: "Автопрокручування",
    file: "Файл: {file}",
    truncated: "Вивід журналу обрізано; показано останній фрагмент.",
  ...
  board: {
    ...
    emptyHint: "Ваш агент може закріплювати віджети тут — спробуйте попросити картку стану.",
    ...
    widget: {
      ...
      sandboxOriginRequired:
        "Авторизація віджета не вдалася після повторних спроб оновлення. Якщо gateway працює за зворотним проксі або тунелем, який не маршрутизує порт пісочниці віджета, установіть mcp.apps.sandboxOrigin на окреме публічне джерело, маршрутизоване до слухача пісочниці.",
      ...
      actionErrorDetail: "Панель керування зберегла попередній стан віджета.",
  ...
  workboard: {
    ...
    dashboardEmpty: "Панелі керування ще немає — робочий агент може закріплювати віджети.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchRequiresAdmin: "Для перемикання гілок потрібен доступ адміністратора оператора.",
    ...
    board: {
      ...
      resizeDock: "Змінити розмір доку чату",
      reopenChat: "Показати чат",
      workboardCard: "Картка робочої дошки: {title}, {status}",
      defaultTab: "Головна",
      mockPlaceholder: "Межа подання дошки · {tabs} вкладок · {widgets} віджетів",
      mockOverview: "Огляд",
      mockResearch: "Дослідження",
      mockSessionStatus: "Статус гілки",
      mockRecentFindings: "Нещодавні знахідки",
      mockSourceMap: "Карта джерел",
      resetTitle: "Скинути розмову?",
      resetDescription: "Контекст розмови буде скинуто. Ваша інформаційна панель залишиться.",
    },
    catalog: {
    ...
    workspaceConflict: {
      ...
      commandHelp:
        "Запустіть ці команди в Bash або zsh (Git Bash у Windows). Якщо inspect повідомляє, що шлях не існує, його видалила хмара; перевірте це й видаліть локальний шлях вручну. Якщо checkout повідомляє про конфлікт файлу/каталогу, перемістіть або видаліть блокувальний локальний шлях, а потім повторіть спробу. Якщо staged ref відсутній, сповіщення застаріле; не змінюйте локальний шлях.",
      commandsUnavailable:
        "Ця назва файлу містить керівні символи термінала, тому OpenClaw не створюватиме для неї придатну для копіювання команду оболонки. Перевірте staged ref напряму й уважно введіть шлях вручну.",
      dismiss: "Відхилити сповіщення про конфлікт робочого простору",
      ...
      eventDescription: "Локальні версії для цих шляхів збережено; інші хмарні зміни застосовано.",
    },
    compaction: {
    ...
    messages: {
      ...
      hide: "Сховати",
      hideConfirm: "Сховати це повідомлення в цьому браузері? Агент усе одно його бачить.",
      hideMessage: "Сховати повідомлення",
      hideTooltip: "Сховати лише в цьому браузері",
      openInCanvas: "Відкрити в полотні",
      reply: "Відповісти",
      replyToMessage: "Відповісти на повідомлення",
      rewind: "Повернутися назад",
      rewindConfirm: "Повернутися до стану перед цим повідомленням?",
      rewindToHere: "Повернутися сюди",
      rewindUnavailable: "Повернення назад недоступне, поки агент працює",
    ...
    composer: {
      ...
      cameraInput: "Камера",
      cameraListUnsupported: "Цей браузер не може показати список камер.",
      ...
      holdToRecordSetting: "Утримуйте кнопку мікрофона, щоб диктувати",
      holdToRecordSettingDescription:
        "Утримуйте кнопку мікрофона в композері, говоріть, а потім відпустіть, щоб вставити текст без надсилання.",
      ...
      dictationFinalizationTimedOut:
        "Диктування зупинено до завершення останнього часткового розшифрування.",
  ...
  cron: {
    ...
    form: {
      ...
      summaryEverySeconds: "Виконується кожні {amount} с",
      ...
      script: "Скрипт",
      readOnlyPayloadHelp:
        "Цей payload було створено поза Control UI. Його вміст залишається доступним лише для читання та зберігається, коли ви зберігаєте інші зміни.",
